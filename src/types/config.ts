...
interface CommentsConfig {
  /** Comment provider. Currently only "giscus". */
  provider: "giscus";
  /** Giscus repository in "owner/repo" format, e.g. "user/user.github.io". */
  repo: string;
  /** GitHub repository ID (obtained from giscus.app). */
  repoId: string;
  /** Discussion category name. */
  category: string;
  /** Discussion category ID (obtained from giscus.app). */
  categoryId: string;
  /** How to map pages to discussions. Defaults to "pathname". */
  mapping?: string;
  /** giscus interface language. Defaults to "zh-CN". */
  lang?: string;
  /** giscus theme. Defaults to "preferred_color_scheme". */
  theme?: string;
}
...
interface AstroPaperConfig {
  ...
  /** Comments section shown under each post */
